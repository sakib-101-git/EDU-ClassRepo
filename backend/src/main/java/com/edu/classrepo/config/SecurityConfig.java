    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/semesters/active").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/routine/**").permitAll()
                        ...
                        .requestMatchers("/api/semesters/ingest").hasRole("ADMIN")
